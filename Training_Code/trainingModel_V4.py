...
dataset_url = "D:\\Datasets\\grouped_datasets"
after_training_test_img = "D:/Testing/Control_Images/aphid1.jpg"

# Saves by default to C:/Users/You/ (always save as .h5 for our purposes)
saved_model_name = "buggyAI_V4.1.h5"
...
if os.path.isfile(saved_model_name) is False:
    model.save(saved_model_name)
    print('Model saved!')

### PREDICT ON NEW DATA
test_dir = pathlib.Path(after_training_test_img)
